...
var logOff = document.querySelector("#logOff");
var username = $("#username");
var password = $("#password");
var login = document.querySelector("#login");
var signUp = document.querySelector("#signUp");
var followContent = $("#followContent");
var queryTagContent = $("#queryTagContent");
var follow = document.querySelector("#follow");
var queryTag = document.querySelector("#queryTag");
var queryMention = document.querySelector("#queryMention");
var querySubscribe = document.querySelector("#querySubscribe");
var query = $("#query");
var tweetContent = $("#tweetContent");
var tagsContent = $("#tagsContent");
var mentionsContent = $("#mentionsContent");
var reTweetContent = $("#reTweetContent");
...
signUp.addEventListener("click", function () {
	channel.push("signUp", { username: username.val(), password: password.val() });
});

queryTag.addEventListener("click", function () {
	channel.push("queryTag", { queryTagContent: queryTagContent.val() });
});

queryMention.addEventListener("click", function () {
	channel.push("queryMention", {});
});

querySubscribe.addEventListener("click", function () {
	channel.push("querySubscribe", {});
});

tweet.addEventListener("click", function () {
	channel.push("tweet", { tweetContent: tweetContent.val(), tagsContent: tagsContent.val(), mentionsContent: mentionsContent.val() });
});

reTweet.addEventListener("click", function () {
	channel.push("reTweet", { reTweetContent: reTweetContent.val() });
});

follow.addEventListener("click", function () {
	channel.push("follow", { followContent: followContent.val() });
});

channel.on("queryResponse", function (payload) {
	query.append(payload.body + " <br>");
});

channel.on("liveTweet", function (payload) {
	live.append(payload.body + " <br>");
});

channel.on("loginSuccess", function (payload) {
	alert("" + payload.body);
});

channel.on("loginFail", function (payload) {
	alert("" + payload.body);
});

channel.on("signUpSuccess", function (payload) {
	alert("" + payload.body);
});

channel.on("signUpFail", function (payload) {
	alert("" + payload.body);
});

channel.on("followResult", function (payload) {
	alert("" + payload.body);
});

channel.on("tweetResult", function (payload) {
	alert("" + payload.body);
});
